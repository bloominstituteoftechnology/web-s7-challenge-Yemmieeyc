...
// :point_down: Here are the validation errors you will use with Yup.
const validationErrors = {
  fullNameTooShort: 'full name must be at least 3 characters',
  fullNameTooLong: 'full name must be at most 20 characters',
  sizeIncorrect: 'size must be S or M or L'
}
// :point_down: Here you will create your schema.
...
function Form() {
  ...
  // :point_down: This array could help you construct your checkboxes using .map in the JSX.
  const toppings = [
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="input-group">
        {/* :point_down: Maybe you could generate the checkboxes dynamically */}
      ...
      {/* :point_down: Make sure the submit stays disabled until the form validates! */}
      <input type="submit"
        disabled={!canSubmit}
        value='Submit' />
    </form>
